...
const products = [
    ...
    {id:5, name:'Oppo', model: '555', price:15000, url:'https://m.media-amazon.com/images/I/41sJ50FH9OL._SX300_SY300_QL70_FMwebp_.jpg'}
];
        ...
        <h3>Products List</h3>
        {
            ...
            products.map((product) => (
                <h5 key={product.id}>
                    ...
                    <Link to={"/viewproduct/" + product.id}> {product.name} </Link> 
                    <br/>

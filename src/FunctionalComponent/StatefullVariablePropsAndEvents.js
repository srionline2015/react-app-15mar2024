...
function StatefullVariablePropsAndEvents(prop)
{
    ...
    return <div>
           ...
           <h3>Product Price: {productPrice}</h3> 
            ...
            <button onClick={() => changeProductModel('A123')}>Change Product Model</button>
            <button onClick={() => changeProductPrice('20000')}>Change Product Price</button>
            {/* <button onClick={() => changeProductDetail()}>Change Product Details</button> */}
        ...
        // {
        //     changeProductName('Red Mi');
        //     changeProductModel('A123');
        //     changeProductPrice('20000');
        // };
}
